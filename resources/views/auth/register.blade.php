                    ...
                    <form action="/proses-registrasi" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="text" name="nip_atau_nup" id="nip_atau_nup"
                                    placeholder="Masukkan NIP/NUP Pengguna" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                <select name="role" id="role" required>
                                    ...
                                    <option value="Staff Pelaksana Asset">Staff Pelaksana Asset</option>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (confirmPasswordToggle) {
                    confirmPasswordToggle.addEventListener('click', function() {
                        const type = confirmPasswordField.getAttribute('type') === 'password' ? 'text' :
                            'password';
