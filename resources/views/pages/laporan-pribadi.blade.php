        ...
        <div class="content-area">
            <div class="card">
                <div class="container">
                    ...
                    <form action="{{ route('bukti-kerusakan-pribadi.store') }}" method="POST"
                        ...
                        <div class="upload-container">
                            ...
                            <div class="upload-box" id="uploadBox">
                                ...
                                <input type="file" id="file_bukti_kerusakan" name="file_bukti_kerusakan"
                                    class="file-input" accept="image/jpeg,image/png,image/webp,image/avif">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleFiles(files) {
                ...
                if (!validTypes.includes(file.type)) {
                    fileError.textContent =
                        'Format file tidak didukung. Harap unggah file JPG, PNG, WEBP, atau AVIF.';
                ...
                fetch(form.action, {
                        ...
                        if (data.success) {
                            ...
                            setTimeout(() => {
                                ...
                                // Jika tidak, mungkin redirect ke halaman sebelumnya atau dashboard
                                    ...
                                    '/halaman-laporan-pribadi'; // Ganti dengan URL yang sesuai
                                }
                            }, 2000);
                        } else {
                            // Tampilkan toast error
                            showToast('Error!', data.message ||
                                'Terjadi kesalahan saat menyimpan data.', true);
                    ...
                    .catch(error => {
                        ...
                        showToast('Error!', error.message ||
                            'Terjadi kesalahan jaringan atau server. Silakan coba lagi.', true);
