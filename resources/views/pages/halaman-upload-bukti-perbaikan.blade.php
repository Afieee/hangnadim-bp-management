                    ...
                    <form action="{{ route('bukti-perbaikan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-container">
                            <div class="form-group">
                                ...
                                <input type="text" id="catatan" name="catatan_bukti_perbaikan" class="form-control"
                                    placeholder="Masukkan catatan perbaikan" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="file-input-container">
                                    <label class="file-input-label">
                                        ...
                                        <input type="file" class="file-input" name="file_bukti_perbaikan"
                            ...
                            <div class="form-group">
                                <input type="text" id="id_kerusakan" name="id_bukti_kerusakan" class="form-control"
                                    hidden value="{{ $buktiKerusakan->id }}" readonly required>
                            </div>

                            <div class="form-group">
                                <input type="text" id="id_inspektor" name="id_user_inspektor" class="form-control"
                                    hidden value="{{ Auth::user()->id }}" readonly required>
                            </div>
                        </div>
                        ...
                        <div class="gallery-grid">
                            @foreach ($buktiPerbaikan as $perbaikan)
                                <div class="gallery-item"
                                    onclick="openModal('{{ $perbaikan->url_foto }}', '{{ $perbaikan->catatan_bukti_perbaikan }}')">
                                    @if ($perbaikan->url_foto)
                                        <div class="gallery-img-container">
                                            <img src="{{ $perbaikan->url_foto }}" alt="Bukti Perbaikan"
                                                class="gallery-img">
                                        </div>
                                    @else
                                        <div class="no-image">
                                    ...
                                    <div class="gallery-info">
                                        <p><strong>Catatan Dari Petugas:</strong>
                                            {{ $perbaikan->catatan_bukti_perbaikan }}</p>
    ...
    <body>
        ...
        <div class="content-wrapper" id="content-wrapper">
            ...
            <div class="content-area">
                <div class="card">
                    <div class="gallery-container">
                        <h2 class="gallery-title">Data Bukti Perbaikan - {{ $buktiKerusakan->judul_bukti_kerusakan }}
                        </h2>
