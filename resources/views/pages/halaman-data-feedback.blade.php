                                ...
                                @forelse ($feedback as $index => $item)
                                    <tr>
                                                ...
                                                <div class="feedback-note">
                                                    ...
                                                    @if (strlen($item->catatan_feedback) > 50)
                                                        <a href="#" class="read-more" data-bs-toggle="modal"
                                                            data-bs-target="#feedbackModal{{ $item->id }}">Selengkapnya</a>
                                                    @endif
                                                </div>
                                            @else
                                                -
                                        ...
                                        <td>
                                            ...
                                            <span
                                                class="rating-badge {{ $predikatClass }}">{{ $item->predikat_rating_pelayanan }}</span>
                                        </td>
                                        <td>{{ \Carbon\Carbon::parse($item->penjadwalanTamu->waktu_tamu_mendarat)->translatedFormat('d F Y, \\p\\u\\k\\u\\l H:i') }}
                                            WIB</td>
                                    </tr>
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        ...
                                        @if ($feedback->hasMorePages())
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $feedback->nextPageUrl() }}"
