                ...
                <div class="card">
                    <div class="card-custom p-4">
                        ...
                        <div class="header-container">
                            <h2 class="page-title">Rekapitulasi Kedatangan Tamu</h2>

                            <div class="d-flex flex-wrap gap-3 align-items-center">
                                <form action="{{ route('tampil.manage.kedatangan') }}" method="GET"
                            ...
                            <table class="table-custom">
                                ...
                                <tbody>
                                    @forelse($tamu as $item)
                                        <tr>
                                            <td>{{ $loop->iteration + ($tamu->currentPage() - 1) * $tamu->perPage() }}
                                            </td>
                                            ...
                                            <td>
                                                <span class="badge-time bg-blue-100 text-blue-800">
                                                    {{ \Carbon\Carbon::parse($item->waktu_penggunaan_gedung)->locale('id')->translatedFormat('l, d F Y • H:i') }}
                                                    WIB
                                                </span>
                                            </td>
                                            <td>
                                                <span class="badge-time bg-green-100 text-green-800">
                                                    {{ \Carbon\Carbon::parse($item->waktu_selesai_penggunaan_gedung)->locale('id')->translatedFormat('l, d F Y • H:i') }}
                                                    WIB
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                @if ($item->lembar_disposisi)
                                                    <a href="{{ asset('storage/' . $item->lembar_disposisi) }}"
