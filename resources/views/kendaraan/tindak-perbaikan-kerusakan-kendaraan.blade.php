                    ...
                    <form action="{{ route('simpan.bukti.perbaikan.kerusakan.kendaraan') }}" method="POST"
                        ...
                        <div class="form-container">
                            <div class="form-group">
                                ...
                                <input type="text" id="catatan" name="catatan_perbaikan" class="form-control"
                            ...
                            <div class="form-group">
                                <input type="text" id="id_kerusakan_kendaraan" name="id_kerusakan_kendaraan" hidden
                                    class="form-control" value="{{ $kerusakan->id }}" readonly required>
                            </div>
                        </div>
                                    ...
                                    @if ($perbaikan->file_bukti_perbaikan)
                                        <div class="gallery-img-container">
                                            @if (Str::endsWith($perbaikan->file_bukti_perbaikan, ['.pdf']))
                                                <iframe src="{{ asset('storage/' . $perbaikan->file_bukti_perbaikan) }}"
                                                    class="gallery-img"
